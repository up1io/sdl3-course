...
APP_CreateAndSubmitCube(struct APP_Context *ctx) 
{
  ...
  transfer_data[4] = (struct APP_PositionColorVertex){-10, -10, 10, 255, 255, 0, 255};
  transfer_data[5] = (struct APP_PositionColorVertex){10, -10, 10, 255, 255, 0, 255};
  transfer_data[6] = (struct APP_PositionColorVertex){10, 10, 10, 255, 255, 0, 255};
  transfer_data[7] = (struct APP_PositionColorVertex){-10, 10, 10, 255, 255, 0, 255};

  transfer_data[8] = (struct APP_PositionColorVertex){-10, -10, -10, 255, 0, 255, 255};
  transfer_data[9] = (struct APP_PositionColorVertex){-10, 10, -10, 255, 0, 255, 255};
  transfer_data[10] = (struct APP_PositionColorVertex){-10, 10, 10, 255, 0, 255, 255};
  transfer_data[11] = (struct APP_PositionColorVertex){-10, -10, 10, 255, 0, 255, 255};
  ...
  transfer_data[16] = (struct APP_PositionColorVertex){-10, -10, -10, 0, 255, 255, 255};
  transfer_data[17] = (struct APP_PositionColorVertex){-10, -10, 10, 0, 255, 255, 255};
  transfer_data[18] = (struct APP_PositionColorVertex){10, -10, 10, 0, 255, 255, 255};
  transfer_data[19] = (struct APP_PositionColorVertex){10, -10, -10, 0, 255, 255, 255};

  transfer_data[20] = (struct APP_PositionColorVertex){-10, 10, -10, 0, 0, 255, 255};
  transfer_data[21] = (struct APP_PositionColorVertex){-10, 10, 10, 0, 0, 255, 255};
  transfer_data[22] = (struct APP_PositionColorVertex){10, 10, 10, 0, 0, 255, 255};
  transfer_data[23] = (struct APP_PositionColorVertex){10, 10, -10, 0, 0, 255, 255};
